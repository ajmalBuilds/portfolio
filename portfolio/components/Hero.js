        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="relative inline-block">
              Creative
              <span className="absolute -bottom-1 left-0 right-0 h-1 bg-gradient-to-r from-teal-500 to-blue-500"></span>
            </span>{' '}
            Developer & Designer
          </h1>
          ...
          >
            I build exceptional digital experiences that inspire and delight users.
            Let's bring your vision to life with elegant, responsive, and functional design.
          </p>
          ...
          <div ref={ctaRef} className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a 
              ...
              className="px-8 py-3 bg-teal-600 text-white font-medium rounded-lg shadow-lg hover:bg-teal-700 transition-all duration-300 transform hover:scale-105"
            >
              View My Work
            </a>
            <a 
              ...
              className="px-8 py-3 border-2 border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-medium rounded-lg hover:border-teal-600 hover:text-teal-600 dark:hover:border-teal-400 dark:hover:text-teal-400 transition-all duration-300 transform hover:scale-105"
            >
              Contact Me
            </a>
          </div>
